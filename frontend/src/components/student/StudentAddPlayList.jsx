...
export default function StudentAddPlayList() {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const response = await ApiServices.AddPlayList(payload);
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div className="bg-gradient-to-r from-cyan-50 to-rose-50 py-6 px-8 border-b border-cyan-100">
                <h1 className="text-2xl font-bold text-gray-800">Create New Playlist</h1>
                <p className="text-gray-600 mt-1">
                    Create a new playlist to organize your learning resources
                </p>
            </div>
                    ...
                    {videoLinks.map((link, index) => (
                        <div key={index} className="flex items-center mb-2">
                            <input
                                ...
                                className={`flex-grow px-4 py-2.5 rounded-lg border ${errors.videoLinks && index === 0 ? 'border-rose-500' : 'border-gray-300'} focus:ring-2 focus:ring-rose-500 focus:border-transparent`}
                            />
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-xs text-gray-500">
                                {isPublic
                                    ? "This playlist will be visible to all users"
